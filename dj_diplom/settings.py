...
if os.getenv("TESTING") == "1":
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv("SQL_DATABASE", "dj_diplom"),
            'USER': os.getenv("SQL_USER", "owner_dj_diplom"),
            'PASSWORD': os.getenv("SQL_PASSWORD", "owner_dj_diplom"),
            'HOST': os.getenv("SQL_HOST", "dj_diplom_db_1"),
